---
layout: post
title: "[Kafka] 11장. Docker로 Schema Registry 실습해보기"
description: " "
date: 2021-01-15
tags: [Kafka]
comments: true
...
- [Kafka 기초 다지기](#kafka-기초-다지기)
      - [Docker로 Schema Registry 실습해보기](#docker로-schema-registry-실습해보기)
      - [**목차**](#목차)
      - [:house: **돌아가기**](#house-돌아가기)
      - [1. 준비작업](#1-준비작업)
      - [2. 테스트용 토픽 생성 및 메시지 전송](#2-테스트용-토픽-생성-및-메시지-전송)
      - [3. 스키마 레지스트리 활용](#3-스키마-레지스트리-활용)
      - [4. REST 프록시 사용](#4-rest-프록시-사용)
