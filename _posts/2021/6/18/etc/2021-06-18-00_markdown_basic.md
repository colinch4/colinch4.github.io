---
layout: post
title: "[markdown]  마크다운(Markdown) basic"
description: " "
date: 2021-06-18
tags: [markdown]
comments: true
...
> 헤더는 제목을 표현할 때 사용합니다. 단순히 글자의 크기를 표현하는 것이아닌 의미론적인 중요도를 나타냅니다.
...
> git은 컴퓨터 파일의 변경사항을 추적하고 여러 명의 사용자들 간에 해당 파일들의 작업을 조율하기위한 분산버전 관리 시스템이다.
...
타이포라 - 환경설정에서 바꾸면 위와 같이 표현 할 수 있음!!