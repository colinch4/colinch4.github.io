...
또한 BindingAdapter 는 선택적으로 기존 값을 취할 수도 있습니다. 기존 값과 새 값을 취하는 함수는 속성의 모든 기존 값을 먼저 가진 후 새 값을 가져 와야 합니다.
...
이벤트 핸들러의 경우 오직 한개의 추상함수를 가진 추상클래스 혹은 인터페이스와 사용 할 수 있습니다.
