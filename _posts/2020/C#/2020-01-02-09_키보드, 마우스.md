...
* 컨트롤 안에서 발생하는 이벤트 처리는 다음과 같다
  ...
  > ![image](https://github.com/colinch4/colinch4.github.io/blob/master/_posts/2020/C%23/마우스_1.png?raw=true)



#### 폼 위에서의 마우스 이벤트

* ![image](https://github.com/colinch4/colinch4.github.io/blob/master/_posts/2020/C%23/마우스_2.png?raw=true)
