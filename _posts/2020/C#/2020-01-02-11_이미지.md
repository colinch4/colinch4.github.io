...
- `DoubleBufferd` 속성 코드로 설정하는 방법
  ...
  - `SetStyle(ControlStyles.OptimizedDoubleBuffer,true);`
    ...
    > ![image](https://github.com/colinch4/colinch4.github.io/blob/master/_posts/2020/C%23/더블버퍼링.png?raw=true)
...
- 리소스 디자이너 실행
  ...
  >
  > ![image](https://github.com/colinch4/colinch4.github.io/blob/master/_posts/2020/C%23/리소스이미지_1.png?raw=true)

- 실행 파일에 포함 속성 설정

  > 이미지 Persistence 속성 변경
  >
  > ![image](https://github.com/colinch4/colinch4.github.io/blob/master/_posts/2020/C%23/리소스이미지_2.png?raw=true)
