...
위와 같은 Lambda 식은 Kotlin에서 제공하는  [SAM(Single Abstract Method)](https://colinch3.github.io/2020-02-21/sam)  정의에 의해 동작하고 있다.
...
Kotlin에서는  [Higher-Order Function](https://colinch3.github.io/2020-02-21/higher-order-funstions)이 제공되고 있으므로, 중요치 않으며  [처음 설계부터 위와 같이 동작하도록 만들어두었다.](https://discuss.kotlinlang.org/t/kotlin-and-sam-interface-with-two-parameters/293/2)
...
리스트를 넘겨받고,  `selector: (T) -> R`의 람다식을  [Higher-Order Function](https://colinch3.github.io/2020-02-21/higher-order-funstions)으로 전달하고 있다.
...
-   [Kotlin Higher-Order Functions 사용방법](https://colinch3.github.io/2020-02-21/higher-order-funstions)
-   [Kotlin SAM(Single Abstract Method)을 사용하는 방법](https://colinch3.github.io/2020-02-21/sam)
-   [Kotlin 입문](https://colinch3.github.io/2020-02-14/Kotlin-%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%98%EB%B0%8D-%EC%96%B8%EC%96%B4-%EC%95%8C%EC%95%84%EB%B3%B4%EA%B8%B0)
