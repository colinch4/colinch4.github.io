## Effective Java 2/E
1. __객체의 생성과 삭제__
  * 01. 생성자 대신 정적 팩토리 메소드를 사용할 수 없는지 생각해보라
...
3. __클래스와 인터페이스__
  ...
  * 14. public 클래스 안에는 public 필드를 두지 말고 접근자 함수를 사용하라
  * 15. 변경 가능성을 최소화하라
  * 16. 계승하는 대신 구성하라
...
8. __에외__
  ...
  * 62. 함수에서 던져지는 모든 예외에 대해 문서를 남겨라
