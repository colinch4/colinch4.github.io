...
1. 값
   ...
   * 이진수 표기는 달라질 수 있음
     ...
     >```
     >
     >![static_cast 1](https://github.com/colinch4/colinch4.github.io/blob/master/_posts/2020/C++/images/static_cast_1.png)
     >
     >비트값과 값 둘 다 바뀌지 않음
     ...
     > ```
     >
     > ![static_cast 2](https://github.com/colinch4/colinch4.github.io/blob/master/_posts/2020/C++/images/static_cast_2.png)
     >
...
* 가장 위험한 캐스팅
  ...
  > 예시
  >
  > ![reinterpret_cast](https://github.com/colinch4/colinch4.github.io/blob/master/_posts/2020/C++/images/reinterpret_cast.png)
